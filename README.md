...
Thank you for using this gem. You will find it really usefull and afficient for building forms in your rails app.
...
Use `HexletCode.form_for(object, options)` to build the form 
